...
import img1 from "@/assets/blogwriting.png";
import img2 from "@/assets/shduling.png";
import img3 from "@/assets/automataiojn.png";
import img4 from "@/assets/seo.png";
import { FaArrowRight } from "react-icons/fa";
const Services = () => {
  return (
    <div className="my-20 md:px-16 px-8">
      <div className="flex items-center justify-around text-secondary">
        <div>
          <h1 className="text-[45px] font-light">What can</h1>
          <h1 className="text-5xl font-bold font-bask">JustMade do for you?</h1>
        </div>
      ...
      <div className="mt-20 grid grid-cols-2 gap-5 px-32">
        <div className="bg-[#ffa7ec] hover:bg-primary hover:scale-105 transition duration-300 text-secondary p-8 space-y-5 rounded-xl">
          ...
          <p className="text-justify text-sm">
            ...
            exercitationem architecto maxime porro, corporis quibusdam dolores
            dolorem dicta dignissimos nostrum, temporibus, repudiandae debitis
            ea. Accusantium laborum voluptatem laboriosam iusto!
          </p>
          <Link
            href=""
        ...
        <div className="bg-[#ffa7ec] hover:bg-primary hover:scale-105 transition duration-300 text-secondary p-8 space-y-5 rounded-xl">
          <div className="flex items-center space-x-5">
            ...
            >
              ...
              <circle cx="39.57061" cy="13.98461" r="5.06978" fill="#ffa7ec" />
              <circle cx="58.81422" cy="13.98461" r="5.06978" fill="#ffa7ec" />
              <rect
                x="73.84385"
                y="86.97284"
                width="155.98055"
